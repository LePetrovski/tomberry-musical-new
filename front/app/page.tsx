	...
	return (
		<>
			...
			{/* <section className="border-b border-zinc-200 bg-gradient-to-b from-zinc-50 to-white">
				...
				<p className="mb-4 text-sm font-medium uppercase tracking-[0.2em] text-secondary-500">
					Vitrine
				</p>
				<h1 className="max-w-3xl text-4xl font-semibold tracking-tight text-secondary-900 sm:text-5xl">
				...
				<div className="mt-10 flex flex-wrap gap-4">
					...
					<Link
					href="/blog"
					className="rounded-full border border-zinc-300 px-6 py-3 text-sm font-medium text-secondary-700 transition hover:border-zinc-400 hover:bg-zinc-50"
					>
					Lire le blog
					</Link>
				</div>
			...
			{/* <section className="border-t border-zinc-200 bg-zinc-50">
				...
				<div className="mb-10 flex items-end justify-between gap-4">
					...
					<p className="mt-2 text-secondary-600">Analyses, coulisses et ressources.</p>
					</div>
					<Link href="/blog" className="text-sm font-medium text-secondary-700 hover:text-secondary-900">
					Voir tout →
					</Link>
				</div>
				{posts.length > 0 ? (
					...
					<p className="rounded-2xl border border-dashed border-zinc-300 bg-white p-8 text-secondary-600">
